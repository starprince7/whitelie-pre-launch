...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { name: "Surveys", href: "/admin/surveys", icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
  ...
  if (status === "loading" || status === "unauthenticated") {
    return (
      <div className="min-h-screen flex justify-center items-center bg-neutral-50">
        <div className="w-12 h-12 border-4 border-t-[#FDCA64] border-r-transparent border-b-transparent border-l-transparent rounded-full animate-spin"></div>
      </div>
    );
  }
        ...
        <div className="flex flex-col w-64 bg-white border-r border-neutral-200">
          <div className="h-0 flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div className="flex items-center flex-shrink-0 px-4">
              <span className="text-xl font-bold text-black">WhiteLie Admin</span>
            </div>
      ...
      >
        <div className="h-full flex flex-col pt-5 pb-4 overflow-y-auto">
          <div className="flex items-center justify-between flex-shrink-0 px-4">
            ...
            <button
              onClick={() => setIsSidebarOpen(false)}
              className="p-2 rounded-md text-neutral-500 hover:text-black hover:bg-neutral-100"
            >
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <header className="md:hidden bg-white shadow-sm z-10">
          <div className="px-4 py-4 flex items-center justify-between">
            ...
            <span className="text-lg font-bold text-black">WhiteLie Admin</span>
            <div className="w-6 h-6"></div> {/* Placeholder for spacing */}
          </div>
        </header>
